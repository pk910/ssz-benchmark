#!/bin/bash
# Update dynamic-ssz codegen to the latest release
...
# Update generate.go
sed -i -E "s|(github.com/pk910/dynamic-ssz/dynssz-gen)@v[0-9]+\.[0-9]+\.[0-9]+(-[^ ]+)?|\1@${LATEST_TAG}|g" "$SCRIPT_DIR/generate.go"
...
echo "dynamicssz-codegen updated to $LATEST_TAG"
